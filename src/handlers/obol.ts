import { ObolToken, ObolGovernor } from "generated";
...
ObolToken.Transfer.handler(async ({ event, context }) => {
...
ObolToken.DelegateChanged.handler(async ({ event, context }) => {
...
ObolToken.DelegateVotesChanged.handler(async ({ event, context }) => {
...
// Governor handlers
ObolGovernor.VoteCast.handler(async ({ event, context }) => {
...
ObolGovernor.ProposalCreated.handler(async ({ event, context }) => {
