import { ZKToken, ZKGovernor } from "generated";
...
ZKToken.Transfer.handler(async ({ event, context }) => {
...
ZKToken.DelegateChanged.handler(async ({ event, context }) => {
...
ZKToken.DelegateVotesChanged.handler(async ({ event, context }) => {
...
// Governor handlers
ZKGovernor.VoteCast.handler(async ({ event, context }) => {
...
ZKGovernor.ProposalCreated.handler(async ({ event, context }) => {
